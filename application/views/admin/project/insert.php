<div class="modal-content">
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
     <input type="text" name="name" class="form-control" id="input-name" placeholder="name" value="<?php echo set_value('name') ?>">
 ...
 <div class="form-group row">
    ...
    <div class="col-sm-10">
     <input type="text" name="description" class="form-control" id="input-description" placeholder="description" value="<?php echo set_value('description') ?>">
